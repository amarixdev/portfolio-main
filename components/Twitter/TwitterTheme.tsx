...
const TwitterTheme = () => {
  ...
  return (
    <div className="lg:px-[160px] xl:px-[280px] bg-[#060606] ">
          ...
          <div className="flex flex-col items-start justify-center">
            ...
            <div className="flex mt-2 gap-3">
              <div className="flex items-center">
                ...
                <h1 className="text-xs lg:text-sm text-[#777777]">Following</h1>
              </div>
              <div className="flex items-center">
                <p className="text-white font-bold mr-1 text-xs lg:text-sm">
                  {following ? "1000" : "999"}
                </p>
                <h1 className="text-xs lg:text-sm text-[#777777]">Followers</h1>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="flex flex-col gap-2">
                <Tweet title="summary">
                  <p className="text-xs xs:text-sm lg:text-base mt-4">
                    ...
                    University of North Carolina - Chapel Hill from 2015 to
                    2019, where I competed in track and field, was a pre-dental
                    student, and medical researcher. I was grateful to receive
                    an invitation to attend Dental School in 2021, but after
                    long consideration and some time off during the pandemic I
                  ...
                  <p className="text-xs xs:text-sm lg:text-base mt-4">
                    ...
                    attention and energy to each project I undertake. Thank you
                    for taking some time to learn more about me and I look
