...
const Skills = ({
  ...
  return (
    <div className="px-4 w-full gap-x-[5%] gap-y-8 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 place-items-center ">
      {Object.keys(skills).map((skillKey: string) => (
        <div
          key={skills[skillKey].name}
          className=" flex relative flex-col items-start justify-center my-10 rounded-lg h-0 w-[80%] pb-[80%] bg-gradient-to-br from-[#161616] to-[#202020] "
        >
