    ...
    <section className="flex flex-col">
      <Tweet title="summary">
        ...
        <p className="text-xs xs:text-sm lg:text-base 2xl:text-lg mt-4">
          I attended the University of North Carolina - Chapel Hill from 2015 to
          2019, where I competed in track and field, pursued a pre-dental course
          of study, and engaged in medical research. While navigating the 2020
          pandemic, I began to teach myself programming and, eventually, decided
          against enrolling in dental school to pursue a career in software
